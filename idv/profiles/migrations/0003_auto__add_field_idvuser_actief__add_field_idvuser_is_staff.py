...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IdvUser.actief'
        db.add_column(u'profiles_idvuser', 'actief',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'IdvUser.is_staff'
        db.add_column(u'profiles_idvuser', 'is_staff',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IdvUser.actief'
        db.delete_column(u'profiles_idvuser', 'actief')

        # Deleting field 'IdvUser.is_staff'
        db.delete_column(u'profiles_idvuser', 'is_staff')
    ...
    models = {
        ...
        u'profiles.idvuser': {
            ...
            'actief': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
