...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profiel.post_postcode'
        db.add_column(u'profiles_profiel', 'post_postcode',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profiel.post_postcode'
        db.delete_column(u'profiles_profiel', 'post_postcode')
    ...
    models = {
        ...
        u'profiles.profiel': {
            ...
            'post_postcode': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
