...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Woning.verkoper'
        db.add_column(u'woning_woning', 'verkoper',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profiles.IdvUser'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Woning.verkoper'
        db.delete_column(u'woning_woning', 'verkoper_id')
